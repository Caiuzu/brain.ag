...
export default class FarmersController {
  ...
  public async store({ request, response }: HttpContextContract) {
    try {
      ...
      Logger.error(error)
      return this.formatError(error, VALIDATE_FARMER_ERROR) || response.internalServerError({ message: CREATE_FARM_ERROR });
    }
  }
  ...
  public async update({ params, request, response }: HttpContextContract) {
    try {
      ...
      Logger.error(error)
      return this.formatError(error, VALIDATE_FARMER_ERROR) || response.internalServerError({ message: FARMER_NOT_FOUND });
    }
  }
